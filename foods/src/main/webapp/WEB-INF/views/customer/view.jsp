				...
				<form name="form1" method="post" action="${path}/customer/update"
					...
					<div style="width: 650px, text-align:center">
						...
						<c:if test="${sessionScope.memberId != null }">
							<textarea rows="2" cols="60" id="replytext"
								placeholder="댓글을 입력하세요" style="float: left;"></textarea>
							<br>
							<button type="button" id="btnReply" style="float: right;"
								class="btn btn-dark">댓글작성</button>
						</c:if>
					</div>
					<!-- 댓글 출력 -->
