		...
		<div class="container px-5">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
					...
					<li class="nav-item"><a class="nav-link" href="${path}/shop">SHOP</a></li>
					<li class="nav-item"><a class="nav-link" href="${path}/food/list">AI식단분석</a></li>
					<li class="nav-item"><a class="nav-link" href="${path}/customer/list">고객문의</a></li>
				</ul>
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
					<c:choose>
						<c:when test="${sessionScope.memberId == null}">
							<!-- 섹션에 아이디가 없으면 로그인이 안된상태 if-->
							<li class="nav-item"><a class="nav-link" href="${path}/login">로그인</a></li>
							<li class="nav-item"><a class="nav-link" href="${path}/member/write">회원가입</a></li>
						</c:when>
						<c:when test="${sessionScope.admin== 1}">
							<!-- admin으로 로그인했을때-->
							<li class="nav-item"><span class="nav-link">관리자 로그인중입니다.</span></li>
						...
						<c:otherwise>
							...
							<li class="nav-item"><a class="nav-link" href="${path}/member/list">Mypage</a></li>
							<li class="nav-item"><a class="nav-link" href="${path}/loginout">로그아웃</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
