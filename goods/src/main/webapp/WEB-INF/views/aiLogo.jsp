                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="site-nav-bar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="aiLogo.jsp">AI추천로고</a></li>
                    ...
                    <div class="boxed">
                       <div class="col-sm-12">
                           <div id="partner-slider" class="owl-carousel">
                                <div class="item">
                                    <img src="resources/images/6.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="resources/images/7.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="resources/images/8.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="resources/images/9.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="resources/images/6.png" alt="partner">
                                </div>
